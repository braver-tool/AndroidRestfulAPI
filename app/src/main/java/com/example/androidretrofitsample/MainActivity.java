package com.example.androidretrofitsample;
...
import com.example.androidretrofitsample.api.APIUrlBase;
import com.example.androidretrofitsample.api.ApiBase;
...
import com.example.androidretrofitsample.postApi.PostApiDocumentsItem;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.multiPartApiButton).setOnClickListener(v -> callRetrofitMultiPartApi());
